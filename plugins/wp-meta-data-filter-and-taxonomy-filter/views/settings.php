...
<div class="wrap">
    <h2><?php if (MetaDataFilter::$is_free): ?><a href="http://wp-filter.com/a/buy" target="_blank" class="button button-primary"><?php _e("GET Premium version", 'meta-data-filter') ?></a>&nbsp;<?php endif; ?><?php _e("MDTF Settings", 'meta-data-filter') ?> v.<?php echo MetaDataFilter::get_plugin_ver() ?>&nbsp;&nbsp;&nbsp;<a href="https://wp-filter.com/documentation/" target="_blank" class="button"><?php _e("Read", 'meta-data-filter') ?></a>&nbsp;&amp;&nbsp; <a href="https://wp-filter.com/video/" target="_blank" class="button"><?php _e("Watch", 'meta-data-filter') ?></a></h2>
        ...
        <div id="tabs">
            <ul>
                ...
                <?php if (class_exists('MDF_POSTS_MESSENGER')): ?>
                    <li><a href="#tabs-6"><?php _e("Messenger", 'meta-data-filter') ?></a></li>
                <?php endif; ?>
                <?php if (class_exists('MDF_SEARCH_STAT')): ?>
                    <li><a href="#tabs-7"><?php _e("Statistic", 'meta-data-filter') ?></a></li>
                <?php endif; ?>

                <li><a href="#tabs-8"><?php _e("Advanced options", 'meta-data-filter') ?></a></li>
                <li><a href="#tabs-9"><?php _e("Info", 'meta-data-filter') ?></a></li>
            </ul>
...
//+++
            ...
            if (class_exists('MDF_POSTS_MESSENGER')):
                ...
                $data['header_email_messenger'] = (isset($data['header_email_messenger']) ? $data['header_email_messenger'] : __("New Posts by your request", 'meta-data-filter'));
                $data['subject_email_messenger'] = (isset($data['subject_email_messenger']) ? $data['subject_email_messenger'] : __("New Posts", 'meta-data-filter'));
                $data['text_email_messenger'] = (isset($data['text_email_messenger']) ? $data['text_email_messenger'] : __("Dear [DISPLAY_NAME], we increased the range of our products. Number of new products: [PRODUCT_COUNT]", 'meta-data-filter'));
                ...
                <div id="tabs-6">
                    ...
                    <table class="form-table">
                        <tbody>
                            ...
                            <tr valign="top">
                                <th scope="row"><label><?php _e("Short Description", 'meta-data-filter') ?></label></th>
                                <td>
                                    <a href="https://wp-filter.com/extension/post-messenger/" class="button" target="_blank"><?php _e("Read How to use here", 'meta-data-filter') ?></a>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("Label", 'meta-data-filter') ?></label></th>
                                <td>
                                    <input type="text" class="regular-text" value="<?php echo $data['label_messenger'] ?>" name="meta_data_filter_settings[label_messenger]">
                                    <p class="description"><?php _e("The text before subscription block", 'meta-data-filter') ?></p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("WordPress cron period", 'meta-data-filter') ?></label></th>
                                <td>
                                    <?php
                                    $wp_cron_period = "no";
                                    ...
                                    $cron_periods = array(
                                        ...
                                        'twicemonthly' => __('twicemonthly', 'meta-data-filter'),
                                    ...
                                    <p class="description"><?php _e('Period of emailing to subscribed users. Set it to "No" if you going to use external cron. ', 'meta-data-filter') ?></p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("External cron key (is recommended as flexible for timetable)", 'meta-data-filter') ?></label></th>
                                <td>
                                    ...
                                    <p class="description"><?php _e('For external cron use the next link', 'meta-data-filter'); ?>: <i class="woof_cron_link" ><b><?php echo get_home_url() . "?mdf_pm_cron_key=" . $data['use_external_cron']; ?></b></i><br />
                                        <?php _e('To reset the key, just delete it here and save the plugin settings OR write by hands your own. Key should be min 16 symbols.', 'meta-data-filter'); ?> </p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("Max subscriptions per user", 'meta-data-filter') ?></label></th>
                                <td>
                                    <input type="text" class="regular-text" value="<?php echo $data['subscr_count'] ?>" name="meta_data_filter_settings[subscr_count]">
                                    <p class="description"><?php _e("Maximum number of subscriptions for a single registered user. ", 'meta-data-filter') ?></p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("Title of the email", 'meta-data-filter') ?></label></th>
                                <td>
                                    ...
                                    <p class="description"><?php _e("Text in the email header.", 'meta-data-filter') ?></p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("Subject of the email", 'meta-data-filter') ?></label></th>
                                <td>
                                    ...
                                    <p class="description"><?php _e("Subject of the email. ", 'meta-data-filter') ?></p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("Text of the email", 'meta-data-filter') ?></label></th>
                                <td>
                                    ...
                                    <p class="description"><?php _e("Text in the body of the email. You can use next variables: [DISPLAY_NAME], [USER_NICENAME], [PRODUCT_COUNT]. ", 'meta-data-filter') ?></p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("Subscription time", 'meta-data-filter') ?></label></th>
                                <td>
                                    <?php
                                    ...
                                    $date_expire = array(
                                        'no' => __('No limit', 'meta-data-filter'),
                                        'week' => __('One week', 'meta-data-filter'),
                                        'twicemonthly' => __('Two weeks', 'meta-data-filter'),
                                        'month' => __('One month', 'meta-data-filter'),
                                        'twomonth' => __('Two months', 'meta-data-filter'),
                                            //'min1' => __('min1', 'meta-data-filter')
                                    );
                                    ?>
                                    ...
                                    <p class="description"><?php _e('How long user will get emails after subscription. ', 'meta-data-filter') ?></p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("Emails count", 'meta-data-filter') ?></label></th>
                                <td>
                                    <input type="text" class="regular-text" value="<?php echo $data['count_message'] ?>" name="meta_data_filter_settings[count_message]">
                                    <p class="description"><?php _e("Maximum number of emails per one subscribed user. -1 means no limit. ", 'meta-data-filter') ?></p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("Priority of limitations", 'meta-data-filter') ?></label></th>
                                <td>
                                    <?php
                                    ...
                                    $priority_limit = array(
                                        'by_date' => __('By date', 'meta-data-filter'),
                                        'by_count' => __('By emails count', 'meta-data-filter'),
                                        'both' => __('Both', 'meta-data-filter'),
                                    );
                                    ?>
                                    ...
                                    <p class="description"><?php _e('Which limitation has priority. Event after which user stop getting the emails. Both - means that any first event ("Subscription time" or "Emails count") of two ones, will reset user subscription.', 'meta-data-filter') ?></p>
                                </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label><?php _e("Notes for customer", 'meta-data-filter') ?></label></th>
                                <td>
                                    ...
                                    <p class="description"><?php _e("Any text notes for customer under subscription form.", 'meta-data-filter') ?></p>
                                </td>
                            </tr>
            ...
            <div id="tabs-8">
                ...
                <table class="form-table">
                    <tbody>
                        ...
                        <tr valign="top">
                            <th scope="row"><label for="gmap_user_api_key"><?php _e("Google Map  API key", 'meta-data-filter') ?></label></th>
                            <td>
                                <fieldset>
                                    <label>
                                ...
                                <p class="description"><?php _e("", 'meta-data-filter') ?></p>
                            </td>
                        </tr>
                        ...
                        <?php if (isset($_SERVER['SCRIPT_URI']) OR isset($_SERVER['REQUEST_URI'])): ?>
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <p class="description"><?php _e("This option excludes initialization of the plugin on all pages of the site except links in the textarea. One row - one link!<br />Example: http://woocommerce.wp-filter.com/ajaxed-search-7/ - slash in the end of the link should be!", 'meta-data-filter') ?></p>
                                </td>
                            </tr>
                        <?php endif; ?>
                            ...
                            <td>
                                ...
                                <ul style="margin: 6px;">                                   
                                    ...
                                    <li>
                                        ...
                                        <p class="description"><?php _e("WordPress plugin for managing and bulk edit WooCommerce Products data in the reliable and flexible way! Be professionals with managing data of your e-shop!", 'meta-data-filter') ?></p>
                                    </li>
        ...
        <table style="width: 100%;">
            <tbody>
                <tr>
                    ...
                    <td style="width: 25%;">
                        <h3>WooCommerce Bulk Editor Professional:</h3>
                        <a href="https://bulk-editor.com/" target="_blank"><img src="<?php echo self::get_application_uri() ?>images/woobe_banner.png" width="300" alt="WOOBE - WooCommerce Bulk Editor Professional" style="width: 100%" /></a>
                    </td>
