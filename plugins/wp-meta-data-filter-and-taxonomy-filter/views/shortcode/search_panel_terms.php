            ...
            switch ($val['type']) {
                ...
                case "range_select":
                    ...
                    if (!empty($filter_data[$key]['from'])) {
                        $from = __("From:", 'meta-data-filter') . $val["range_select_prefix"] . $filter_data[$key]['from'] . $val["range_select_postfix"];
                    }
                    if (!empty($filter_data[$key]['to'])) {
                        $to = __("to:",'meta-data-filter') . $val["range_select_prefix"] . $filter_data[$key]['to'] . $val["range_select_postfix"];
                    }
                    if (empty($from) AND empty($to)) {
                        break;
                    }
