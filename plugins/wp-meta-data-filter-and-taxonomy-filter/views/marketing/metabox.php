...
<table class="form-table">
    <tbody>
        ...
        <tr valign="top">
            <th scope="row"><?php _e("Link", 'meta-data-filter') ?><br></th>
            <td>
                <fieldset>
        ...
        <tr valign="top">
            <th scope="row"><?php _e("Link SEO prefix", 'meta-data-filter') ?><br></th>
            <td>
                <fieldset>
        ...
        <tr valign="top">
            <th scope="row"><?php _e("Link SEO suffix", 'meta-data-filter') ?><br></th>
            <td>
                <fieldset>
