...
<div style="display:none;" class="mdf_admin_flter_item_box">
    ...
    <div class="data_group_item_html">
        ...
        <div class="data_group_item_template_range_select data_group_input_type" style="display: <?php echo(isset($itemdata) ? ($itemdata['type'] == 'range_select' ? "block" : "none") : "none") ?>">
            <h4><?php _e("From^To", 'meta-data-filter') ?></h4>
            <input type="text" placeholder="<?php _e("example", 'meta-data-filter') ?>:0^100" value="<?php echo(isset($itemdata) ? $itemdata['range_select'] : '') ?>" name="html_item[<?php echo $uniqid ?>][range_select]" style="width: 45%;" /><br />
            <h4><?php _e("Slider step", 'meta-data-filter') ?></h4>
            <input type="text" placeholder="<?php _e("0 or empty mean auto step", 'meta-data-filter') ?>" value="<?php echo(isset($itemdata['range_select_step']) ? $itemdata['range_select_step'] : '') ?>" name="html_item[<?php echo $uniqid ?>][range_select_step]" style="width: 45%;" /><br />
            <h4><?php _e("Prefix", 'meta-data-filter') ?></h4>
            <input type="text" placeholder="<?php _e("Example: $", 'meta-data-filter') ?>" value="<?php echo(isset($itemdata['range_select_prefix']) ? $itemdata['range_select_prefix'] : '') ?>" name="html_item[<?php echo $uniqid ?>][range_select_prefix]" style="width: 45%;" /><br />
            <h4><?php _e("Postfix", 'meta-data-filter') ?></h4>
            <input type="text" placeholder="<?php _e("Example: €", 'meta-data-filter') ?>" value="<?php echo(isset($itemdata['range_select_postfix']) ? $itemdata['range_select_postfix'] : '') ?>" name="html_item[<?php echo $uniqid ?>][range_select_postfix]" style="width: 45%;" /><br />
            <h4><?php _e("Prettify", 'meta-data-filter') ?></h4>
        ...
        <div class="data_group_item_template_by_author data_group_input_type" style="display: <?php echo(isset($itemdata) ? ($itemdata['type'] == 'by_author' ? "block" : "none") : "none") ?>">
           <i><?php _e("Show search by author(select)", 'meta-data-filter') ?></i>
        </div>
