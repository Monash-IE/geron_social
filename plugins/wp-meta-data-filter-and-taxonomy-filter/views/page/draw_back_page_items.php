                    ...
                    <?php if ($item['type'] == 'slider'): ?>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php _e($item['name']); ?>
                                ...
                                if ($is_reflected)
                                {
                                    printf('<br /><i style="font-size:11px;">' . __('is reflected by %s', 'meta-data-filter') . '</i>', $reflected_key);
                                } else
                                {
                                    ...
                                    <fieldset>
                                        ...
                                        <label for="<?php echo $key ?>">
                                            ...
                                            <?php if (!$is_reflected): ?>
                                                ...
                                                ?>
                                                <input type="text"  placeholder="<?php _e("example", 'meta-data-filter') ?>:<?php echo($min + 1) ?>" id="<?php echo $key ?>" name="page_meta_data_filter[<?php echo $key ?>]" value="<?php echo $range_select_value ?>" />
                                            <?php else: ?>
                                                <?php
                                                if (!empty($reflected_key))
                                                {
                                            ...
                                            <br /><i><?php
                                            if($min!=0 AND $max!=0){
                                             echo(__('min', 'meta-data-filter') . ' :' . $min . ', ' . __('max', 'meta-data-filter') . ': ' . $max) ?>. <?php _e($item['description']) ;
                                            }
                                            ?></i>
                                        </label>
                                    </fieldset>
                    ...
                    <?php endif; ?>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <fieldset>
                                    <legend class="screen-reader-text"><span><?php _e($item['name']) ?></span></legend>
                                    <label for="<?php echo $key ?>">&nbsp;<?php  _e('By author', 'meta-data-filter') ?>&nbsp;</label>
                                </fieldset>
                            </td>
                        </tr>
