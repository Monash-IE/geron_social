...
class MDF_Marketing extends MetaDataFilterCore {
    ...
    public static function init() {
        ...
        $args = array(
            'labels'=>array(
                'name'=>__('MDTF Marketing', 'meta-data-filter'),
                'singular_name'=>__('Marketing Links', 'meta-data-filter'),
                'add_new'=>__('Add New Link', 'meta-data-filter'),
                'add_new_item'=>__('Add New Link', 'meta-data-filter'),
                'edit_item'=>__('Edit Link', 'meta-data-filter'),
                'new_item'=>__('New Link', 'meta-data-filter'),
                'view_item'=>__('View Link', 'meta-data-filter'),
                'search_items'=>__('Search Links', 'meta-data-filter'),
                'not_found'=>__('No Links found', 'meta-data-filter'),
                'not_found_in_trash'=>__('No Links found in Trash', 'meta-data-filter'),
                'parent_item_colon'=>''
            ),
            'public'=>false,
            'archive'=>false,
        ...
        register_taxonomy(self::$slug_links_cat, array(self::$slug_links), array(
            "labels"=>array(
                'name'=>__('Links Types', 'meta-data-filter'),
                'singular_name'=>__('MDTF Marketing Links Types', 'meta-data-filter'),
                'add_new'=>__('Add New', 'meta-data-filter'),
                'add_new_item'=>__('Add New Marketing Type', 'meta-data-filter'),
                'edit_item'=>__('Edit Marketing Types', 'meta-data-filter'),
                'new_item'=>__('New Marketing Type', 'meta-data-filter'),
                'view_item'=>__('View Marketing Type', 'meta-data-filter'),
                'search_items'=>__('Search Marketing Types', 'meta-data-filter'),
                'not_found'=>__('No Marketing Types found', 'meta-data-filter'),
                'not_found_in_trash'=>__('No Marketing Types found in Trash', 'meta-data-filter'),
                'parent_item_colon'=>''
            ),
            "singular_label"=>__("Marketing Types", 'meta-data-filter'),
    ...
    public static function admin_menu() {
        add_submenu_page('edit.php?post_type=' . self::$slug_links, __("Marketing Settings", 'meta-data-filter'), __("Marketing Settings", 'meta-data-filter'), 'manage_options', 'mdf_marketing_settings', array(__CLASS__, 'draw_settings_page'));
        //add_submenu_page ('edit.php?post_type=' . self::$slug, __ ("MDTF Marketing Types", 'meta-data-filter'), __ ("MDTF Marketing Types", 'meta-data-filter'), 'manage_options', 'edit-tags.php?taxonomy=' . self::$slug_links_cat . '&post_type=' . self::$slug_links);
    }

    public static function admin_init() {
        add_meta_box("mdf_marketing_options", __("MDTF Marketing Options", 'meta-data-filter'), array(__CLASS__, 'draw_options_meta_box'), self::$slug_links, "normal", "high");
    }
    ...
    public static function show_edit_columns( $columns ) {
        $columns = array(
            ...
            "link"=>__("Link", 'meta-data-filter'),
            self::$slug_links_cat=>__("Types", 'meta-data-filter'),
