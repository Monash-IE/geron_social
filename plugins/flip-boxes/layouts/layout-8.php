...
<div class="'.esc_attr($cols).' cfb-box-'.$i.' cfb-box-wrapper">
    <div data-effect="'.esc_attr($effect).'" data-height="'.esc_attr($height).'" class="cfb-flip" style="color:'.esc_attr($flipbox_color_scheme).'">

        <div class="cfb-face cfb-front cfb-data" style="background:linear-gradient(rgba(255, 255, 255, 0.24), rgba(255, 255, 255, 0.24)), url('.esc_attr($flipbox_image).')">';
                ...
                $layout_html .= '<div class="cfb-title">'.esc_html($flipbox_title).'</div>
