    ...
    class TagGroups_Terms
    {
        ...
        )
        {
            ...
            if ( $force_rerun || $count_only ) {
                ...
                $term_ids = get_transient( 'tag_groups_sort_groups' );
            }
            ...
            if ( $term_ids === false ) {
                ...
                $term_ids = get_terms( $args );
                // Try to keep for 10 minutes so that our offset always starts with unprocessed items.
                set_transient( 'tag_groups_sort_groups', $term_ids, 600 );
            }
            ...
            if ( is_array( $term_ids ) ) {
                foreach ( $term_ids as $term_id ) {
                    ...
                    if ( !empty(array_diff_assoc( $groups_sorted, $groups_a )) ) {
         ...
         * @return void
         */
        public function clear_post_count_transient( $rebuild_in_seconds = 10 )
        {
            global  $tag_groups_premium_fs_sdk ;
            $languages = apply_filters( 'wpml_active_languages', NULL, '' );
